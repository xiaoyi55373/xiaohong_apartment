package com.xiaohong.lease.web.admin.controller.user;
...
import com.xiaohong.lease.web.admin.service.UserInfoService;
import com.xiaohong.lease.web.admin.vo.user.UserInfoQueryVo;
...
public class UserInfoController {
    ...
    public Result<IPage<UserInfo>> pageUserInfo(@RequestParam long current, @RequestParam long size, UserInfoQueryVo queryVo) {
        ...
        Page<UserInfo> list = service.page(page, queryWrapper);
