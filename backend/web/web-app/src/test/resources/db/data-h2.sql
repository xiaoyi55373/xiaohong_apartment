...
MERGE INTO lease_agreement (id, user_id, phone, name, apartment_id, room_id, lease_start_date, lease_end_date, lease_term_id, rent, deposit, payment_type_id, status, create_time, update_time, is_deleted) VALUES
(1, 1, '13800138001', '张三', 1, 1, DATEADD('MONTH', -1, CURRENT_DATE), DATEADD('MONTH', 11, CURRENT_DATE), 1, 3500.00, 3500.00, 1, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(2, 2, '13800138002', '李四', 2, 4, DATEADD('MONTH', -2, CURRENT_DATE), DATEADD('MONTH', 10, CURRENT_DATE), 2, 4500.00, 4500.00, 2, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);

-- ==================== 浏览历史数据 ====================

MERGE INTO browsing_history (id, user_id, room_id, browse_time, create_time, update_time, is_deleted) VALUES
(1, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(2, 1, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(3, 1, 3, DATEADD('DAY', -5, CURRENT_TIMESTAMP), DATEADD('DAY', -5, CURRENT_TIMESTAMP), DATEADD('DAY', -5, CURRENT_TIMESTAMP), 0),
(4, 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(5, 2, 4, DATEADD('DAY', -10, CURRENT_TIMESTAMP), DATEADD('DAY', -10, CURRENT_TIMESTAMP), DATEADD('DAY', -10, CURRENT_TIMESTAMP), 0),
(6, 3, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);

-- ==================== 图片信息数据 ====================

MERGE INTO graph_info (id, name, item_type, item_id, url, create_time, update_time, is_deleted) VALUES
(1, '公寓封面1', 1, 1, 'https://example.com/apartment1.jpg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(2, '房间图片1', 2, 1, 'https://example.com/room1.jpg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
