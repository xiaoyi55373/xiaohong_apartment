...
export function getSysRoleList() {
  return http.get<Role>(`/admin/system/role/list`)
}
/**
...
export function getSysDeptTree() {
  return http.get<DeptInterfacesRes[]>(`/admin/system/dept/listAsTree`)
}
/**
 * @description 新增用户
 */
...
export function updateSysPermission(data: PermissionListInterfaceRes) {
  return http.put(`/admin/system/menu/saveOrUpdate`, data)
}
/**
 * @description 新增菜单
 * @returns
...
export function updateSysDepartmentStatus(id: number, status: number) {
  return http.get(`/admin/system/dept/updateStatus/${id}/${status}`)
}
/**
 * @description 新增部门
 * @returns
...
export function addSysDepartment(data: DeptInterfacesRes) {
  return http.post(`/admin/system/dept/save`, data)
}
/**
 * @description 修改更新部门
 * @returns
...
export function updateSysDepartment(data: DeptInterfacesRes) {
  return http.put(`/admin/system/dept/update`, data)
}
/**
 * @description 删除部门
 * @param { string } id
...
export function deleteSysDepartment(id: string | number) {
  return http.delete(`/admin/system/dept/remove/${id}`)
}
/**
...
export function getSysOperationLogList(
  ...
  return http.get<PageResponseInterface<SysUserInterfaceRes[]>>(
    `/admin/system/operationLog/${params.pageNum}/${params.pageSize}`,
    {
      title: params.title,
...
export function getSysLoginLogList(params: SysLoginLogListParamsInterfaceReq) {
  return http.get<PageResponseInterface<SysUserInterfaceRes[]>>(
    `/admin/system/loginLog/${params.pageNum}/${params.pageSize}`,
    {
